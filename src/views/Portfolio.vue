...
<template>
    ...
    <section id="work" class="mt-[80px] xl:mt-[200px] relative z-20">
        <div class="container mx-auto lg:p-0">
            <h3 class="sr_portfolio__title h3 font-secondary font-bold text-accent text-center mb-2">
                portfolio
            </h3>
            <h2 class="sr_portfolio__subtitle text-center h2 mt-2 text-textColor-secondary font-semibold">Highlights of My Creations</h2>
